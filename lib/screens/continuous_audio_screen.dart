                  ...
                  sliver: SliverList.list(children: [
                        ...
                        for (final minutes in const [5, 10, 15, 30])
                          ChoiceChip(
                            ...
                            onSelected: _playing || _paused
                                ? null
                                : (_) =>
                                    setState(() => _sessionMinutes = minutes),
                            label: Text(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton.filled(
                                  key:
                                      const ValueKey('continuous-audio-toggle'),
                                  iconSize: 34,
                                  onPressed: _playing
                                      ? _pause
                    ...
                    Text(
                        state.tr(
                            ...
                            en:
                                'Found: ${filtered.length} · Queue: ${_queue.length}',
                            ar:
                    ...
                    return Padding(
                      ...
                      child: Material(
                        ...
                        child: ListTile(
                          ...
                          onTap: () => _selectModule(
                              _queue
                                  .indexWhere((item) => item.id == original.id),
                              revealPlayer: true),
                        ),
                      ),
                    );
