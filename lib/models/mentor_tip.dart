...
class MentorTip {
  ...
  static MentorTip build({
    ...
    final refreshAt = DateTime.fromMillisecondsSinceEpoch(
        ...
        isUtc: now.isUtc);
    String tr(String ru, String kk, String en, String ar) => switch (locale) {
          AppLocale.ru => ru,
          AppLocale.kk => kk,
          AppLocale.en => en,
          AppLocale.ar => ar,
      ...
      return result(
          ...
          variant == 0
              ? tr(
                  ...
                  'كل عام وأنت بخير! خصّص بعض الوقت لنفسك: آية مألوفة و$minutes دقائق هادئة.')
              : tr(
                  ...
                  'كل عام وأنت بخير! عُد إلى درس أحببته وتعلّم اليوم بالوتيرة التي تناسبك.'),
      ...
      return result(
          ...
          variant == 0
              ? tr(
                  ...
                  'اكتمل هدفك اليومي: $todayProgress/$dailyGoal. يمكنك الراحة الآن، وسنكمل غدًا.')
              : tr(
                  ...
                  'أنجزت اليوم $todayProgress من الدروس. تذكّر فكرة مفيدة واحدة دون تلميحات، ثم اختتم جلستك.'),
          MentorTipMood.celebrate);
    }
    if (dueReviews > 0) {
      return result(
          ...
          variant == 0
              ? tr(
                  ...
                  'لديك $dueReviews من المراجعات المستحقة. خصّص $minutes دقائق للمادة المألوفة قبل درس جديد.')
              : tr(
                  ...
                  'تنتظرك $dueReviews من المراجعات. حاول تذكّر الإجابة أولًا، ثم تحقّق منها بالرجوع إلى المادة.'),
          MentorTipMood.focus);
    }
      ...
      return result(
          ...
          variant == 0
              ? tr(
                  ...
                  'بعد الانقطاع، ابدأ بدرس مألوف. تكفي $minutes دقائق للعودة بهدوء.')
              : tr(
                  ...
                  'لا حاجة لتعويض كل شيء دفعة واحدة. راجع مقطعًا مألوفًا ثم تابع حين تكون مستعدًا.'),
          MentorTipMood.encourage);
    }
    if (weakItems > 0 || (weakestSkill != null && variant == 0)) {
      final skill = weakestSkill?.titleFor(locale) ??
          tr('Повторение', 'Қайталау', 'Review', 'المراجعة');
      return result(
          'skill',
          variant == 0
              ? tr(
                  ...
                  'لنُنمِّ مهارة «$skill»: ادرس مثالًا واحدًا واشرحه بأسلوبك.')
              : tr(
                  ...
                  'جرّب اختبارًا قصيرًا في «$skill» دون تلميحات، ثم عُد إلى الجزء الذي وجدت فيه صعوبة فقط.'),
          MentorTipMood.focus);
    }
    ...
    final text = variant == 0
        ? tr(
            ...
            'خطوتك التالية هي $chosen. خصّص $minutes دقائق، ثم اختبر ما تستطيع تذكّره دون مساعدة.')
        : profile.tone == MentorTone.focused && personal
            ? tr(
                ...
                'خطة مدّتها $minutes دقائق: $chosen، ثم مثال واحد، ثم اختبار دون تلميحات.')
            : tr(
                ...
                'لنكمل مع $chosen. خذ وقتك: فهم مثال واحد جيدًا أنفع من المرور السريع على عدة أمثلة.');
    return result(
        'next',
        text,
