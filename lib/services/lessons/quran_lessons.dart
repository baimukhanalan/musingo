...
final List<Lesson> quranLessons = [
    ...
    const Lesson(
      ...
      steps: [
        LessonStep(
          type: LessonStepType.text,
          russianText: 'Аль-Баляд означает «Город» — речь о Мекке. Сура говорит: человек сотворён в тяготах, но обольщается силой и богатством, забыв, что Аллах видит его и наделил глазами, языком и устами. Главное в суре — «крутая тропа»: освободить раба, накормить в голодный день сироту или бедняка, а затем быть среди уверовавших, заповедавших друг другу терпение и милосердие.',
        ),
        LessonStep(
          type: LessonStepType.audio,
        ...
        LessonStep(
          ...
          arabicText: 'ثُمَّ كَانَ مِنَ الَّذِينَ ءَامَنُوا۟ وَتَوَاصَوْا۟ بِالصَّبْرِ وَتَوَاصَوْا۟ بِالْمَرْحَمَةِ',
          transliteration: 'Сумма кана миналлязина аману ва таваасау бис-сабри ва таваасау биль-мархама',
          russianText: 'А после этого — быть одним из тех, которые уверовали и заповедали друг другу терпение и милосердие',
        ),
        LessonStep(
          type: LessonStepType.audio,
        ...
        LessonStep(
          ...
          arabicText: 'وَالَّذِينَ كَفَرُوا۟ بِـَٔايَٰتِنَا هُمْ أَصْحَٰبُ الْمَشْـَٔمَةِ',
          transliteration: "Валлязина кафару би-аятина хум асхабуль-маш'ама",
          russianText: 'А те, которые не уверовали в Наши знамения, — люди левой стороны',
        ),
        LessonStep(
          type: LessonStepType.audio,
        ...
        LessonStep(
          ...
          question: 'Соедини транслитерацию и перевод',
          matchPairs: [
            LessonMatchPair(prompt: 'Лякад халякналь-инсана фи кабад', answer: 'Мы сотворили человека в тяготах'),
            LessonMatchPair(prompt: 'Факку ракаба', answer: 'Это — освобождение раба'),
            LessonMatchPair(prompt: 'Уляика асхабуль-маймана', answer: 'Таковы люди правой стороны'),
          ],
        ),
        LessonStep(
          type: LessonStepType.speak,
    ...
    const Lesson(
      ...
      steps: [
        LessonStep(
          type: LessonStepType.text,
          russianText: 'Аль-Баййина означает «Ясное знамение». Сура объясняет, зачем был послан Пророк ﷺ: чтобы к людям пришло ясное знамение и правдивые Писания. Её ключевой аят сводит религию к сути — искренне поклоняться Аллаху, совершать намаз и выплачивать закят. В конце — две группы: наихудшие из творений и наилучшие, которым уготованы сады Эдема.',
        ),
        LessonStep(
          type: LessonStepType.audio,
          quranGlobalAyahNumber: 6131,
          arabicText: 'لَمْ يَكُنِ الَّذِينَ كَفَرُوا۟ مِنْ أَهْلِ الْكِتَٰبِ وَالْمُشْرِكِينَ مُنفَكِّينَ حَتَّىٰ تَأْتِيَهُمُ الْبَيِّنَةُ',
          transliteration: "Лям якуниллязина кафару мин ахлиль-китаби валь-мушрикина мунфаккина хатта та'тияхумуль-баййина",
          russianText: 'Неверующие из людей Писания и многобожников не расстались с неверием, пока к ним не явилось ясное знамение',
        ),
        LessonStep(
          type: LessonStepType.audio,
        ...
        LessonStep(
          ...
          arabicText: 'وَمَا تَفَرَّقَ الَّذِينَ أُوتُوا۟ الْكِتَٰبَ إِلَّا مِنۢ بَعْدِ مَا جَآءَتْهُمُ الْبَيِّنَةُ',
          transliteration: "Ва ма тафарракаллязина утуль-китаба илля мим ба'ди ма джаатхумуль-баййина",
          russianText: 'Те, кому было даровано Писание, распались только после того, как к ним явилось ясное знамение',
        ),
        LessonStep(
          type: LessonStepType.audio,
          quranGlobalAyahNumber: 6135,
          arabicText: 'وَمَآ أُمِرُوٓا۟ إِلَّا لِيَعْبُدُوا۟ اللَّهَ مُخْلِصِينَ لَهُ الدِّينَ حُنَفَآءَ وَيُقِيمُوا۟ الصَّلَوٰةَ وَيُؤْتُوا۟ الزَّكَوٰةَ ۚ وَذَٰلِكَ دِينُ الْقَيِّمَةِ',
          transliteration: "Ва ма умиру илля лия'будуллаха мухлисына ляхуд-дина хунафаа ва юкымус-саляата ва ю'туз-закяата, ва залика динуль-кайима",
          russianText: 'А ведь им было велено лишь поклоняться Аллаху, служа Ему искренне, как ханифы, совершать намаз и выплачивать закят. Это — правая вера',
        ),
        LessonStep(
          type: LessonStepType.audio,
          quranGlobalAyahNumber: 6136,
          arabicText: 'إِنَّ الَّذِينَ كَفَرُوا۟ مِنْ أَهْلِ الْكِتَٰبِ وَالْمُشْرِكِينَ فِى نَارِ جَهَنَّمَ خَٰلِدِينَ فِيهَآ ۚ أُو۟لَٰٓئِكَ هُمْ شَرُّ الْبَرِيَّةِ',
          transliteration: 'Инналлязина кафару мин ахлиль-китаби валь-мушрикина фи нари джаханнама халидина фиха, уляика хум шарруль-бариййа',
          russianText: 'Воистину, неверующие из людей Писания и многобожников окажутся в огне Геенны и пребудут там вечно. Они — наихудшие из творений',
        ),
        LessonStep(
          type: LessonStepType.audio,
          quranGlobalAyahNumber: 6137,
          arabicText: 'إِنَّ الَّذِينَ ءَامَنُوا۟ وَعَمِلُوا۟ الصَّٰلِحَٰتِ أُو۟لَٰٓئِكَ هُمْ خَيْرُ الْبَرِيَّةِ',
          transliteration: "Инналлязина аману ва 'амилюс-салихати уляика хум хайруль-бариййа",
          russianText: 'Воистину, те, которые уверовали и совершали праведные деяния, — наилучшие из творений',
        ),
        LessonStep(
          type: LessonStepType.audio,
          quranGlobalAyahNumber: 6138,
          arabicText: 'جَزَآؤُهُمْ عِندَ رَبِّهِمْ جَنَّٰتُ عَدْنٍۢ تَجْرِى مِن تَحْتِهَا الْأَنْهَٰرُ خَٰلِدِينَ فِيهَآ أَبَدًۭا ۖ رَّضِىَ اللَّهُ عَنْهُمْ وَرَضُوا۟ عَنْهُ ۚ ذَٰلِكَ لِمَنْ خَشِىَ رَبَّهُۥ',
          transliteration: "Джазаухум 'инда раббихим джаннату 'аднин таджри мин тахтихаль-анхару халидина фиха абада, радыяллаху 'анхум ва раду 'анх, залика лиман хашия раббах",
          russianText: 'Их воздаянием у их Господа будут сады Эдема, в которых текут реки. Они пребудут в них вечно. Аллах доволен ими, и они довольны Им. Это — для того, кто боится своего Господа',
        ),
        LessonStep(
          type: LessonStepType.listenChoice,
          quranGlobalAyahNumber: 6137,
        ...
        LessonStep(
          ...
          question: 'Соедини транслитерацию и перевод',
          matchPairs: [
            LessonMatchPair(prompt: 'фиха кутубун кайима', answer: 'В них — правдивые Писания'),
            LessonMatchPair(prompt: "Инналлязина аману ва 'амилюс-салихати уляика хум хайруль-бариййа", answer: 'Уверовавшие и творившие благое — наилучшие из творений'),
            LessonMatchPair(prompt: 'расулюм миналлахи ятлю сухуфам мутаххара', answer: 'Посланник от Аллаха, который читает очищенные свитки'),
          ],
        ),
        LessonStep(
          type: LessonStepType.speak,
