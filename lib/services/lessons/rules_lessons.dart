  ...
  const Lesson(
    ...
    steps: [
      ...
      LessonStep(
        ...
        question:
            'Какой настрой, по уроку, помогает начать обучение правильно?',
        answers: [
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            '«Бисмиллях» (بِسْمِ اللَّهِ) переводится как «С именем ___». '
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            'Какая тройка понятий, по уроку, важна в исламе при обучении?',
        answers: [
    ...
    steps: [
      ...
      LessonStep(
        ...
        matchPairs: [
          ...
          LessonMatchPair(
              prompt: 'Понимать', answer: 'Связать текст со смыслом'),
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            'Аят 2:2 называет Коран «худан лиль-муттакын». Что это значит?',
        answers: [
  ...
  const Lesson(
    ...
    steps: [
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            'Намаз начинается с такбира «Аллаху ___». Какое слово верное?',
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            'Какая практика, по уроку, названа центральной для мусульманина?',
  ...
  const Lesson(
    ...
    steps: [
      ...
      LessonStep(
        ...
        matchPairs: [
          LessonMatchPair(
              prompt: 'Вера в Аллаха', answer: 'Единый Творец и Господь всего'),
          LessonMatchPair(
  ...
  const Lesson(
    ...
    steps: [
      ...
      LessonStep(
        ...
        matchPairs: [
          LessonMatchPair(prompt: 'Шахада', answer: 'Свидетельство веры'),
          LessonMatchPair(prompt: 'Закят', answer: 'Обязательная милостыня'),
          LessonMatchPair(
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            'Что из перечисленного действительно является столпом ислама?',
        answers: [
          'Намаз (молитва)',
  ...
  const Lesson(
    ...
    steps: [
      ...
      LessonStep(
        ...
        matchPairs: [
          LessonMatchPair(prompt: 'СубханАллах', answer: 'Пречист Аллах'),
          LessonMatchPair(prompt: 'Аллаху Акбар', answer: 'Аллах Велик'),
          LessonMatchPair(
      ...
      LessonStep(
        ...
        answers: ['Хвала Аллаху', 'Пречист Аллах', 'Аллах Велик'],
        correctAnswerIndex: 0,
      ),
      LessonStep(
        type: LessonStepType.question,
        question:
            '«___ Аллах» означает «Пречист Аллах». Какое слово пропущено?',
      ...
      LessonStep(
        type: LessonStepType.question,
        question:
            'Какое поминание переводится как «Нет божества, кроме Аллаха»?',
        answers: ['Ля иляха илля Ллах', 'СубханАллах', 'Альхамдулиллях'],
        correctAnswerIndex: 0,
      ),
      LessonStep(
        type: LessonStepType.question,
