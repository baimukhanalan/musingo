...
class LearningRecommendationLocalization {
  ...
  static const _recommendations = [
    [
      ...
      'ابدأ بالحروف العربية وأصواتها. يساعدك الدرس الأول على تمييز الفروق والتدرّب على الاستماع من البداية.',
    ],
    [
      ...
      'أنت تتعرّف على الحروف. ابدأ بالمقاطع والتراكيب القصيرة بدلًا من إعادة الأبجدية كاملة.',
    ],
    [
      ...
      'لديك أساس قوي. سنتجاوز الأبجدية ونبدأ بالكلمات القرآنية وقراءة الآيات.',
    ],
    [
      ...
      'لديك مهارات القراءة الأساسية. سيبدأ المسار بالحركات والحروف التي تحتاج إلى تدريب والكلمات القرآنية.',
    ],
    [
      ...
      'ابدأ بدرس تمهيدي قصير عن الإسلام والقرآن، ثم انتقل إلى أسئلة التحقّق من الفهم.',
    ],
    [
      ...
      'سنبدأ بتحسين نطق العبارات المألوفة: الاستماع إلى نموذج وتكراره ومراجعة الأخطاء المحتملة.',
    ],
    [
      ...
      'ابدأ بسورة الفاتحة: سندرس المعنى جزءًا جزءًا ونربطه بالكلمات العربية.',
    ],
    [
