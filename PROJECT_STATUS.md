...
**Текущий production deployment:** `dpl_6BmW7jqDJEfV3npC8VSJCp6X5iYS` (Ready)
...
- **Курс: ровно 100 уроков** (арабский 22, Коран 68, основы 10). **Джуз Амма (суры 78–114) покрыт полностью**, все 11 сур Джуза Табарак (67–77) и 9 сур Джуза Аль-Муджадиля (58–66) получили отдельные тематические уроки.
- **Учебный путь прокручивается внутри фиксированной панели** с вкладками «Основы / Коран / Арабский», поэтому Академия и следующие блоки доступны без пролистывания десятков уроков. Переключение курса больше не вызывает обязательное модальное окно языка.
...
### Контент / курс (100 уроков)
- Арабский: a1–a22 — полный алфавит, танвин/шадда/мадд, формы букв, разрывающие соединение буквы, солнечные/лунные буквы, кораническая лексика, остановка и чтение смысловыми группами.
- Коран: 68 уроков — Фатиха + **весь Джуз Амма, суры 78–114** + тематические маршруты по всем сурам **Джуза Табарак, 67–77** и **Джуза Аль-Муджадиля, 58–66**. Арабский текст новых уроков посимвольно проверяется по `assets/data/quran-uthmani-tanzil.txt`.
...
- Джуз Аль-Муджадиля: 9 уроков по сурам Аль-Муджадиля, Аль-Хашр, Аль-Мумтахана, Ас-Сафф, Аль-Джумуа, Аль-Мунафикун, Ат-Тагабун, Ат-Талак и Ат-Тахрим. Каждый урок содержит 9 шагов того же полного цикла, включая аргументированный вопрос и произношение после образца.
...
- **Больше контента:** углубить Джузы Табарак и Аль-Муджадиля до поаятного маршрута и расширять основы/таджвид только после экспертной проверки.
